...
export class AlmanacHelper {
   ...
   */
  static getKnowledgeLevel(
    playerStats: PlayerStats,
    passengerId: number,
  ): 0 | 1 | 2 | 3 {
    const entry: AlmanacEntry | undefined = (playerStats.almanacProgress || {})[
      passengerId
    ];
