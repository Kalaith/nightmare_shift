...
import type { Rule, PlayerStats, GameState, GameEngineResult, HiddenRuleViolation, Passenger, Guideline } from '../types/game';
...
export class GameEngine {
  ...
  static generateShiftGuidelines(playerExperience: number, difficultyLevel: number): GameEngineResult {
