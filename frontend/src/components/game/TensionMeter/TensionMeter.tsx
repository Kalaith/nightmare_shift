...
export const TensionMeter: React.FC<TensionMeterProps> = ({
  ...
  const calculateTensionFactors = (): TensionFactors => {
    ...
    const tellConflict = conflictingTells
      ? 0.8
      : (missedTells.length / Math.max(1, detectedTells.length)) * 0.6;
    ...
    <div className={styles.tensionContainer}>
      ...
      <div className={styles.psychologySection}>
        <div className={styles.indicator}>
          ...
          <div className={styles.doubtMessage}>"{getDoubtMessage()}"</div>
        </div>
      ...
      <div className={styles.phaseIndicator}>
        ...
        <span
          className={`${styles.phaseValue} ${styles[`phase${GuidelineEngine.getLearningCurvePhase(gameState)}`]}`}
        >
