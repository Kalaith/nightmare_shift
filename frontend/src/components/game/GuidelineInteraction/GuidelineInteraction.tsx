...
import type { GameState, Passenger, Guideline, DetectedTell, GuidelineDecision } from '../../../types/game';
    ...
    <div className={styles.interactionContainer}>
      ...
      <div className={styles.phaseHeader}>
        <div className={styles.phaseIndicator}>
          <div className={`${styles.phaseStep} ${interaction.phase === 'analyzing' ? styles.active : styles.completed}`}>
            <span className={styles.stepNumber}>1</span>
            <span className={styles.stepLabel}>Analyzing</span>
          </div>
          <div className={styles.phaseConnector} />
          <div className={`${styles.phaseStep} ${interaction.phase === 'observing' ? styles.active : interaction.phase === 'deciding' ? styles.completed : ''}`}>
            <span className={styles.stepNumber}>2</span>
            <span className={styles.stepLabel}>Observing</span>
          </div>
          <div className={styles.phaseConnector} />
          <div className={`${styles.phaseStep} ${interaction.phase === 'deciding' ? styles.active : ''}`}>
              ...
              {interaction.activeGuideline && (
                <div className={styles.guidelineContext}>
                  ...
                  <div className={styles.guidelineCard}>
                    <span className={styles.guidelineTitle}>{interaction.activeGuideline.title}</span>
                    <span className={styles.guidelineDesc}>{interaction.activeGuideline.description}</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className={styles.decidingPhase}>
            <div className={styles.decisionContext}>
              ...
              <p className={styles.decisionDescription}>
                Based on your observations, what's your choice regarding "{interaction.activeGuideline.title}"?
              </p>
            </div>
