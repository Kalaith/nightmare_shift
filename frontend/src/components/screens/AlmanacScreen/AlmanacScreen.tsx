...
const AlmanacScreen: React.FC<AlmanacScreenProps> = ({
    ...
    const encounteredPassengers = allPassengers.filter(p =>
        getAlmanacEntry(p.id).encountered
    );
            ...
            >
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                        <h4 className="text-white font-semibold">{entry.encountered ? passenger.name : '???'}</h4>
                                ...
                                {!selectedEntry.encountered ? (
                                    ...
                                    <>
                                        ...
                                        {selectedEntry.knowledgeLevel >= 2 && selectedPassenger.routePreferences && (
                                            <div className="mb-6">
                                                <h3 className="text-lg font-semibold text-purple-300 mb-2">Route Preferences</h3>
                                        ...
                                        {selectedEntry.knowledgeLevel >= 3 && (
                                            <div className="mb-6">
                                                ...
                                                <div className="bg-gray-900 p-4 rounded mb-3">
                                                    <p className="text-gray-300 italic">{selectedPassenger.backstoryDetails}</p>
                                                </div>
                                        ...
                                        {selectedEntry.knowledgeLevel < 3 && (
                                            <button
                                                onClick={() => canUpgrade(selectedEntry) && onUpgradeKnowledge(selectedPassenger.id)}
