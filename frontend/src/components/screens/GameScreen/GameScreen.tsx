...
const GameScreen: React.FC = () => {
  ...
  const formatTime = (minutes: number) => {
    const hours = Math.floor(
      minutes / GAME_BALANCE.TIME_FORMATTING.MINUTES_PER_HOUR,
    );
        ...
        <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300">
                      From: {gameState.currentPassenger.pickup}
                    </p>
                    <p className="text-gray-300">
                      To: {gameState.currentPassenger.destination}
                    </p>
          ...
          {gameState.gamePhase === "driving" &&
            (() => {
              ...
              const routeOptions = GameResultHelpers.unwrapOr(
                routeOptionsResult,
                [],
              );
                ...
                const basicRoutes = [
                  {
                    ...
                    riskLevel: 1,
                    available:
                      gameState.fuel >= 1 && gameState.timeRemaining >= 1,
              ...
              return (
                <div className="bg-gray-800/50 border border-gray-600 rounded-lg p-6">
                            ...
                            <div className="text-lg font-bold flex items-center gap-2">
                              ...
                              {route.fareModifier &&
                                ...
                                AlmanacHelper.canSeeFareModifiers(
                                  ...
                                  >
                                    {route.fareModifier > 1.0 ? "+" : ""}
                                    {Math.round((route.fareModifier - 1) * 100)}
                                    % fare
                                  </span>
                                )}
                            </div>
                  ...
                  <div className="mt-4 text-center text-gray-400 text-sm">
                    ...
                    {Math.floor(gameState.timeRemaining)} min • 💰 $
                    {gameState.earnings}
                  </div>
                </div>
              );
          ...
          {gameState.gamePhase === "dropOff" &&
            gameState.lastRideCompletion && (
              <DropOffState
                ...
                backstoryUnlocked={
                  gameState.lastRideCompletion.backstoryUnlocked
                }
