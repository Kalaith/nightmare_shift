...
export const guidelineData: Guideline[] = [
  {
    ...
    description: "Avoid looking directly at passengers to prevent supernatural consequences",
    difficulty: 'medium',
    type: 'basic',
    visible: true,
    isGuideline: true,
    ...
    exceptions: [
      {
        ...
        passengerTypes: ["Ghost of former taxi passenger", "Lost child who doesn't realize he's been missing"],
        conditions: [
          {
        ...
        tells: [
          ...
          },
          {
            type: 'behavioral',
            intensity: 'moderate',
            description: "Passenger fidgets nervously and glances at mirror repeatedly",
  ...
  
  {
    ...
    description: "Stick to the designated route to avoid getting lost or encountering danger",
    difficulty: 'hard',
    type: 'basic',
    visible: true,
    isGuideline: true,
    ...
    exceptions: [
      {
        ...
        passengerTypes: ["Escaped from something in the woods", "Runner who encountered supernatural"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "Don't take",
  ...
  
  {
    ...
    description: "Only accept cash to avoid cursed coins or spectral payment methods",
    difficulty: 'hard',
    type: 'basic',
    visible: true,
    isGuideline: true,
    ...
    exceptions: [
      {
        ...
        passengerTypes: ["Ghost of former taxi passenger", "1940s nightclub performer who died in a fire"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "earthly money",
...

  {
    ...
    description: "Let passengers initiate conversation to avoid drawing supernatural attention",
    difficulty: 'medium',
    type: 'basic',
    visible: true,
    isGuideline: true,
  ...
  
  {
    ...
    description: "Keep the car moving to avoid creatures catching up or passengers turning violent",
    difficulty: 'medium',
    type: 'basic',
    visible: true,
    isGuideline: true,
        ...
        tells: [
          {
            type: 'verbal',
            intensity: 'obvious',
            description: "I'll starve if we don't stop / I'm sick, I'll contaminate you",
            triggerPhrase: "stop",
            reliability: 0.8
          },
          {
  ...
  
  {
    ...
    description: "Maintain closed windows to prevent spirits, smoke, or whispers from entering",
    difficulty: 'medium',
    type: 'basic',
    visible: true,
    isGuideline: true,
...

  {
    ...
    exceptions: [
      {
        id: "speak_nervous_passenger",
        passengerTypes: ["Overworked nurse who made a fatal mistake", "Runner who encountered supernatural"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "Talk to me",
        ...
        tells: [
          ...
          },
          {
            type: 'behavioral',
            intensity: 'moderate',
            description: "Whispers to themselves and glances nervously at driver",
            animationCue: "self_whisper_glance",
            reliability: 0.7
          },
          {
        ...
        breakingSafer: true,
        description: "Nervous passengers need conversation to prevent violent psychological breakdown",
        probability: 0.35
      }
    ],
    followConsequences: [
    ...
    breakConsequences: [
      {
        type: 'death',
        value: 1,
        description: "Breaking silence attracted something hostile from the shadows",
        probability: 0.4
      },
      {
        type: 'reputation',
...

  {
    ...
    exceptions: [
      {
        id: "stop_emergency_need",
        passengerTypes: ["Overworked nurse who made a fatal mistake", "Former doctor who lost license"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "stop",
        ...
        tells: [
          {
            type: 'verbal',
            intensity: 'obvious',
            description: "I need to stop - I'm going to be sick, I'll contaminate everything!",
          ...
          },
          {
            type: 'behavioral',
            intensity: 'moderate',
            description: "Begging repeatedly with increasingly desperate gestures",
            animationCue: "desperate_begging",
            reliability: 0.7
          },
          {
        ...
        breakingSafer: true,
        description: "Some passengers have legitimate medical emergencies that require immediate stops",
        probability: 0.2
      }
    ],
    followConsequences: [
      {
        type: 'survival',
        value: 1,
        description: "Avoided creatures and kept passenger stable during transport",
        probability: 0.75
      },
      {
        type: 'fuel',
    ...
    breakConsequences: [
      {
        type: 'death',
        value: 1,
        description: "Something in the shadows caught up while the car was stopped",
        probability: 0.6
      },
      {
        type: 'time',
...

  {
    ...
    exceptions: [
      {
        id: "windows_suffocation",
        passengerTypes: ["1940s nightclub performer who died in a fire", "Drowned fisherman who refuses to accept his fate"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "air",
            operator: 'contains',
            description: "Passenger mentions breathing problems or need for air"
          },
          {
            type: 'passenger_behavior',
            value: 0.6,
        ...
        tells: [
          ...
          },
          {
            type: 'behavioral',
            intensity: 'moderate',
            description: "Panics when seeing their reflection in the closed glass",
            animationCue: "reflection_panic",
            reliability: 0.7
          },
          {
        ...
        breakingSafer: true,
        description: "Some passengers genuinely need air circulation or suffer from claustrophobia",
        probability: 0.15
      }
    ],
    followConsequences: [
    ...
    breakConsequences: [
      ...
      },
      {
        type: 'fuel',
        value: -3,
        description: "Air resistance from open windows increased fuel consumption",
        probability: 0.7
      }
    ]
  },

  {
    ...
    description: "Stick to main roads to avoid cursed zones and supernatural ambushes",
    difficulty: 'hard',
    type: 'basic',
    visible: true,
    isGuideline: true,
    ...
    exceptions: [
      {
        ...
        passengerTypes: ["Jazz musician who made a deal for talent", "The reaper who collects souls"],
        conditions: [
          {
            type: 'passenger_dialogue',
            value: "late",
        ...
        tells: [
          ...
          },
          {
            type: 'verbal',
            intensity: 'obvious',
            description: "If I'm late, something terrible will happen - they'll come for me!",
        ...
        breakingSafer: true,
        description: "Some passengers face dire supernatural consequences if they arrive late",
        probability: 0.25
      }
    ],
    followConsequences: [
    ...
    breakConsequences: [
      {
        type: 'death',
        value: 1,
        description: "Shortcut led through a cursed zone - something was waiting",
        probability: 0.3
      },
      {
        type: 'time',
