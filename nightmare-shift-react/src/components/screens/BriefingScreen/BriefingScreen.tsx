    ...
    <div className="min-h-screen p-5 bg-gradient-to-b from-gray-800 to-slate-900 text-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-teal-300 mb-2 drop-shadow-lg">📋 Night Shift Briefing</h1>
          <p className="text-lg text-gray-300">Your rules for tonight's shift</p>
        </div>
        
        <div className="space-y-4 mb-8">
          {gameState.currentRules.map((rule, index) => (
            <div key={rule.id} className="bg-gray-800/50 border border-gray-600 rounded-lg p-4 flex gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className={`px-2 py-1 text-xs font-medium rounded border ${getDifficultyColor(rule.difficulty)}`}>
