    ...
    private function getItemData(string $itemName): array
    {
        ...
        $items = [
            'Obsidian Mirror' => [
                'type' => 'protective',
                'rarity' => 'rare',
                'description' => 'Reflects supernatural gazes',
            ...
            'Passenger Manifest' => [
                'type' => 'story',
                'rarity' => 'uncommon',
                'description' => 'A list of names that should never be spoken',
            ],
            'Cold Coffee' => [
                'type' => 'consumable',
                'rarity' => 'common',
                'description' => 'Lukewarm at best',
                'effects' => [['type' => 'fuel_bonus', 'value' => 5]],
            ],
            'Cursed Coin' => [
                'type' => 'cursed',
                'rarity' => 'uncommon',
                'description' => 'It keeps finding its way back',
                'cursedProperties' => [
                    'penaltyType' => 'fuel_drain',
                    'penaltyValue' => 2,
                    'triggersAfter' => 3,
                    'canBeRemoved' => true,
                ],
            ...
            'Lucky Dice' => [
                ...
                'protectiveProperties' => [
                    'protectionType' => 'lucky_encounters',
                    'protectionStrength' => 0.6,
                    'usesRemaining' => 5,
                ],
            ],
        ];
